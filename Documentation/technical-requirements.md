...
- Реализовать добавление, редактирование, удаление и отметку товаров как купленных с категориями, комментариями, приоритетом, примерной ценой, ответственным и историей изменений.
...
- Система должна хранить категорию, приоритет, необязательный комментарий, примерную цену и ответственного за покупку.
...
| Удобство использования | Интерфейс должен быть построен на Bootstrap, поддерживать базовую адаптивность, иметь пункт меню «Инструкция» и прижатый футер на коротких страницах. |
