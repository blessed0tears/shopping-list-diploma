...
- Реализовать добавление, редактирование, удаление и отметку товаров как купленных.
...
- Создатель группы должен автоматически добавляться в группу как участник с ролью `Owner`.
- Пользователь должен видеть только те группы, где он является участником.
- Участник группы должен иметь возможность добавить другого зарегистрированного пользователя в группу по email.
...
- Участник группы должен иметь возможность удалить товар.
